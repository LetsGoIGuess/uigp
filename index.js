...
document.getElementById("frog_buy").onclick = function(){
    ...
    if(frogPurchased == false){
        ...
        document.getElementById("spellImg").style.backgroundImage = "url('pic/frog.png')";
...
document.getElementById("strength_buy").onclick = function(){
    ...
    if(strengthPurchased == false){
        ...
        document.getElementById("spellImg").style.backgroundImage = "url('pic/strength potion.jpg')";
...
document.getElementById("slot_buy").onclick = function(){
    ...
    if(slotPurchased == false){
        ...
        document.getElementById("spellImg").style.backgroundImage = "url('pic/richguy.png')";
